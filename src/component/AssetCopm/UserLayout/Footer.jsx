...
const Footer = () => {
  return (
    <footer className="bg-gray-800 antialiased dark:bg-gray-800">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="border-b border-gray-100 py-6 dark:border-gray-700 md:py-8 lg:py-16">
          <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
            <div className="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
              <div>
                <h6 className="mb-4 text-sm font-semibold uppercase text-white">
                  BookStore
                </h6>
                <ul className="space-y-3">
                  <li>
                    <a
                      href="#"
                      title=""
                      className="text-white hover:text-slate-500 dark:text-white dark:hover:text-white"
                    >
                      {" "}
                      About{" "}
                    </a>
                  ...
                  <li>
                    <a
                      href="#"
                      title=""
                      className="text-white hover:text-slate-500 dark:text-gray-400 dark:hover:text-white"
                    >
                      {" "}
                      Premium{" "}
                    </a>
              ...
              <div>
                <h6 className="mb-4 text-sm font-semibold uppercase text-white dark:text-white">
                  Order &amp; Purchases
                </h6>
                <ul className="space-y-3">
                  <li>
            ...
            <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
              <div className="space-y-5 rounded-lg  dark:bg-gray-700">
                <Link
                  to="/"
                  title=""
                  className="text-base font-medium text-white underline hover:no-underline dark:text-primary-500"
                >
                  {" "}
                ...
                <form action="#">
                  <div className="items-end space-y-4 sm:flex sm:space-y-0">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full cursor-pointer rounded-lg bg-white px-5 py-3 text-center text-sm font-medium text-gray-900 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                      >
                        Subscribe
                      </button>
                    </div>
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="text-white hover:text-gray-200 dark:text-gray-400 dark:hover:text-white"
                  >
                    <svg
                      className="h-5 w-5"
                      fill="currentColor"
        ...
        <div className="py-6 md:py-8">
          <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
            ...
            <ul className="flex flex-wrap items-center gap-4 text-sm text-white dark:text-white xl:justify-center">
              <li>
